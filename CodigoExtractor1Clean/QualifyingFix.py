...
source_folder = "F:/ESCOM-activo/Trabajo terminal/Extractor/output/Qualifying"
destination_folder = "F:/ESCOM-activo/Trabajo terminal/Extractor/CombinedData/CombinedDataQualifying"
        ...
        for driver in os.listdir(grand_prix_path):
            ...
            for file in os.listdir(driver_path):
                if file.endswith(".csv"):
                    ...
                    identifier = f"{grand_prix}_{year}_{circuit_name}_{driver}_Qualifying_{file_type}"
